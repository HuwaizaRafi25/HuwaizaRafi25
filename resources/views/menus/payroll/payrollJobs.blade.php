...
<x-app-layout>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <input type="text" id="searchInput" placeholder="Search"
                                class="w-10 cursor-pointer bg-transparent px-4 py-2 rounded-lg border border-gray-300 focus:w-64 hover:w-64 focus:cursor-text transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent peer" />
                            <svg class="w-5 h-5 text-gray-500 absolute right-2.5 top-2.5 peer-focus:text-purple-600 transition-colors duration-300"
                        ...
                        <!-- Add User Button -->
                        <button
                            class="add-button inline-flex items-center bg-blue-500 text-white font-semibold px-4 py-2 text-sm rounded-lg hover:bg-blue-600 transition-colors duration-200">
    ...
    {{-- Script Modal Delete --}}
    {{-- <script>
        console.log(localStorage.getItem('data-subNavText-id'));
    </script> --}}
            ...
            updateButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const userName = this.getAttribute(
                        'data-user-userName'); // Ambil nama dari atribut data
                    const name = this.getAttribute(
                    ...
                    updateUserForm.querySelector('input[name="username"]').value = userName;
                    updateUserForm.querySelector('input[name="name"]').value = name;
