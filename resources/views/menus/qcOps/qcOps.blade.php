                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            @php
                                                ...
                                                if ($designReq->design) {
                                                    ...
                                                    $completedOps += $designReq->design->qcOperation->sum(
                                                        'quantity_checked',
                                                    );
                                                }
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <a href="#" data-qcOp-idReq="{{ $designReq->id }}"
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                @foreach ($qcOps as $qcOp)
                                    ...
                                    data-address="{{ $user->address }}" data-id="{{ $user->id }}"> --}}
                                        ...
                                        <td class="py-3 px-6 text-left">
                                            <p class="font-semibold flex-nowrap text-nowrap">Inspected By :</p>{{ $qcOp->qc->name }}
                                        </td>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                <a href="#"
                                                data-pic="{{ $qcOp->design->designRequest->reference_image }}"
                                                data-name="{{ $qcOp->design->designRequest->name }}"
                                                data-operator="{{ $qcOp->qc->name }}"
                                                data-worked="{{ $qcOp->quantity_checked }}"
                                                data-comment="{{ $qcOp->comments }}"
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-lg w-full" style="max-height: 95vh; height: auto">
                ...
                <div class="machineOps overflow-y-scroll flex flex-col p-3" id="request-1" style="max-height: 75vh; height: auto;">
                    ...
                    <div class="p-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                            <div>
                                <label for="operator" class="text-gray-600 font-light text-sm">Inspected by :</label>
